...
const ListBox = () => {
    ...
    <div className='flex items-center justify-center p-12'>
        ...
        <Listbox as="div"  value={selectedFruit} onChange={setSelectedFruit}>
            {({open})=>(
                <>
                <Listbox.Label className="text-sm font-medium text-gray-700">Favorite Fruit</Listbox.Label>
                <div className="relative">
                    <span className='inline-block w-full'>
                    <Listbox.Button className="pl-3 py-2 w-full text-left focus:outline-none focus:shadow-outline-blue focus:border-blue-300 relative border shadow">
