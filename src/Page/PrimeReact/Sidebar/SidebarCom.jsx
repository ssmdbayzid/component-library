...
import HeadlessCom from './HeadlessCom';
...
const Header = () =>{
    ...
    const customHeader = (
        <div className="flex align-items-center gap-2">
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dXNlciUyMHByb2ZpbGV8ZW58MHx8MHx8fDA%3D" className='rounded-full h-10 w-10 object-center' />
            <span className="font-bold">Amy Elsner</span>
        </div>
    );
...
const Headless = ()=>{
    ...
    return (
        <div>
            ...
            <div>
                <h2>Main Content</h2>
                <p>Here is the main content of your application.</p>
            </div>
        </div>
    );
}